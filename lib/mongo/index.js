...
let doc = {
  firstName: "arpit",
  lastName: "yadav",
  emailId: "arpit.yadav@gmail.com"
};

function insertFn () {
  // insert and then inserted record will be read
  mongoDao.insertDocument(collectionName, doc);
}
/**
...
DataStore.prototype.get = function (resource, callback) {
  util.log("DataStore -- DataStore.prototype.get");
...
DataStore.prototype.save = function (resources, callback) {
  util.log("DataStore -- DataStore.prototype.save");
...
DataStore.prototype.delete = DataStore.prototype.remove = function (
  ...
  util.log("DataStore -- DataStore.prototype.delete");
...
DataStore.prototype.getCollection = function (collection, callback) {
  util.log("DataStore -- DataStore.prototype.getCollection");
...
DataStore.prototype.deleteCollection = DataStore.prototype.removeCollection = function (
  ...
  util.log("DataStore -- DataStore.prototype.deleteCollection");
...
function save (dataStore, collectionName, resources, callback) {
  ...
  //       let existing = _.find(
  //         existingResources,
  //         resource.filter(dataStore.__router)
  //       );
  //       if (existing) {
  //         // Merge the new data into the existing resource
  //         util.debug(
  //           "%s already exists. Merging new data with existing data.",
  //           resource.toString()
  //         );
...
function openCollection (dataStore, collection, callback) {
  util.log("DataStore -- openCollection");
