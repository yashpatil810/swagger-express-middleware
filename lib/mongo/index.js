...
DataStore.prototype.update = function (resources, callback) {
  util.log("MongoDataStore -- DataStore.prototype.save");

  call(this, update, arguments);
};
...
function update (dataStore, collectionName, resources, callback) {
  util.log("MongoDataStore -- update");
  util.log("MongoDataStore ---------------------------------------- update");
