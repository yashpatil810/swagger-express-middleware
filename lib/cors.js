          ...
          if (req.swagger && req.swagger.path) {
            ...
            res.set(
              ...
              req.get("Access-Control-Request-Method") ||
                swaggerMethods.join(", ").toUpperCase()
            );
          }
          break;
...
function getResponseHeaders (req) {
  util.log("CORS --- getResponseHeaders");
  ...
  if (req.swagger) {
    ...
    if (req.swagger.path) {
      ...
      headers = headers.concat(
        getOperationResponseHeaders(req.swagger.path.options)
      );
    }
...
function getOperationResponseHeaders (operation) {
  util.log("CORS --- getOperationResponseHeaders");
