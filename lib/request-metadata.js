...
function swaggerOperationMetadata (req, res, next) {
  ...
  if (req.swagger.path) {
    ...
    if (method in req.swagger.path) {
      console.log('###@@##', req.swagger.path[method].responses['200']);
      // if (method !== 'post')
      if (req.swagger.path[method].responses['200'].schema.properties.data) {
        const x = req.swagger.path[method].responses['200'].schema.properties.data;
        delete req.swagger.path[method].responses['200'].schema;
        req.swagger.path[method].responses['200'].schema = x;
      }
