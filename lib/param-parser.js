...
function parseSimpleParams (req, res, next) {
  util.log("ParamParser --- parseSimpleParams");
...
function parseFormDataParams (req, res, next) {
  util.log("ParamParser --- parseFormDataParams");
...
function parseBodyParam (req, res, next) {
  util.log("ParamParser --- parseBodyParam ");
...
function parseParameter (param, value, schema) {
  util.log("ParamParser --- parseParameter ");
  ...
  try {
    ...
    throw ono(
      ...
      param.name,
      param.in,
      value === undefined ? param.default : value
    );
  }
}
...
function getParams (req) {
  util.log("ParamParser --- getParams ");
