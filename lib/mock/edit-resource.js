...
function mergeResource (req, res, next, dataStore) {
  ...
  if (req.method !== "POST") {
    util.debug("Saving data at %s", resource.toString());
    dataStore.update(resource, sendResponse(req, res, next, dataStore));
  }
}
...
function overwriteResource (req, res, next, dataStore) {
  util.log("MOCK --- overwriteResource");
  console.log(";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;");
 ...
 * @param   {DataStore} dataStore
 */
function deleteResource (req, res, next, dataStore) {
  util.log("MOCK --- deleteResource");
