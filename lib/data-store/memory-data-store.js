...
MemoryDataStore.prototype.__openDataStore = function (collection, callback) {
  util.log("MemoryDataStore --- MemoryDataStore.prototype.__openDataStore");
 ...
 * @protected
 */
MemoryDataStore.prototype.__saveDataStore = function (
  collection,
  resources,
  callback
) {
  util.log("MemoryDataStore --- MemoryDataStore.prototype.__saveDataStore");
