...
Resource.prototype.toString = function () {
  util.log("Resource --- Resource.prototype.toString");
...
Resource.prototype.merge = function (other) {
  util.log("Resource --- Resource.prototype.merge");
  ...
  if (
    (_.isArray(this.data) && _.isArray(otherData)) ||
...
Resource.prototype.valueOf = function (router, collectionOnly) {
  util.log("Resource --- Resource.prototype.valueOf");
  console.log(router);
  console.log("########", collectionOnly);
...
Resource.prototype.filter = function (router, collectionOnly) {
  util.log("Resource --- Resource.prototype.filter");
...
function getCollectionFromPath (path) {
  util.log("Resource ---  getCollectionFromPath ");
  console.log("Collection Name --- ", path);
...
function getNameFromPath (path) {
  util.log("Resource ---  getNameFromPath");
...
function normalizeCollection (collection) {
  util.log("Resource ---  normalizeCollection");
...
function normalizeName (name) {
  util.log("Resource ---  normalizeName");
